...
const centerOnPoint = (x, y, width, height, zoom) => ({
  x: width / 2 - x * zoom,
  y: height / 2 - y * zoom,
});

const MapSVG = forwardRef(({ width, height }, ref) => {
  const panZoomRef = useRef(null);

  const initialFocus = { x: 1500, y: 315 };
  const initialPan = centerOnPoint(
    initialFocus.x,
    initialFocus.y,
    width,
    height,
  ...
  useEffect(() => {
    if (panZoomRef.current) {
      panZoomRef.current.setValue({
        scale: INITIAL_ZOOM,
        translateX: initialPan.x,
        translateY: initialPan.y,
      });
    }
  ...
  return (
    ...
    >
      ...
      <G id="Group 3">
        ...
        <Path id="1" d="M475 434.5L585.5 417L596 478L485.5 496L475 434.5Z" fill="#cccccc"/>
        <Path id="2" d="M486.488 513.87L596.988 496.37L607.488 557.37L495.5 557.37L486.488 513.87Z" fill="#cccccc"/>
        <Path id="3" d="M305 385.5L349 357L399.5 436L355 464L305 385.5Z" fill="#cccccc"/>
        <Path id="4" d="M451 270.5L526.988 258.37L538 323L461.5 333.5L451 270.5Z" fill="#cccccc"/>
        <Path id="5" d="M428.5 185.5L544 168.5L554 233L433.5 253.5L434.5 230L433.5 205.5L428.5 185.5Z" fill="#cccccc"/>
        <Path id="6" d="M376.5 108.5L530.5 83.5L541.5 151L420 170L409.5 155.5L402 148L388.5 136L379 129.5L376.5 108.5Z" fill="#cccccc"/>
        <Path id="7" d="M718.5 327L766 319L806.012 316L806.012 468L741.5 468L718.5 327Z" fill="#cccccc"/>
        <Path id="8" d="M721 241L804.5 231L805.5 298.5L732 307.009L721 241Z" fill="#cccccc"/>
        <Path id="9" d="M703 130L805.488 138.378L805.488 214L718 223.5L703 130Z" fill="#cccccc"/>
        <Path id="10" d="M744 486.5L887.5 486.5L887.5 595.5L762 595.5L744 486.5Z" fill="#cccccc"/>
        <Path id="11" d="M830.5 44.9999L896 49.9999L889.5 127.508L824 124L830.5 44.9999Z" fill="#cccccc"/>
        <Path id="12" d="M912.863 51.7685L1044 63.5L1037.5 141L906.363 130.769L912.863 51.7685Z" fill="#cccccc"/>
        <Path id="13" d="M1061.36 65L1159 73.5L1153.5 152L1054.86 144L1061.36 65Z" fill="#cccccc"/>
        <Path id="14" d="M1176.86 75.7684L1242.36 80.7684L1236 170.5L1170 166.5L1176.86 75.7684Z" fill="#cccccc"/>
        <Path id="15" d="M1170.76 183.5L1236.76 189L1236 298L1170.76 298L1170.76 183.5Z" fill="#cccccc"/>
        <Path id="16" d="M1169.71 316.5L1236 316.5L1234.95 467.321L1169.71 467.321L1169.71 316.5Z" fill="#cccccc"/>
        <Path id="17" d="M1154 486L1235.5 486L1235.5 594.5L1154 594.5L1154 486Z" fill="#cccccc"/>
        <Path id="18" d="M1053.99 485.757L1135.49 485.757L1135.49 594.257L1053.99 594.257L1053.99 485.757Z" fill="#cccccc"/>
        <Path id="19" d="M1319.5 498L1401 498L1401 594.5L1319.5 594.5L1319.5 498Z" fill="#cccccc"/>
        <Path id="20" d="M1418.55 497.757L1500.05 497.757L1500.05 594.256L1418.55 594.256L1418.55 497.757Z" fill="#cccccc"/>
        <Path id="21" d="M1518.55 497.757L1582 497.757L1582 594.256L1518.55 594.256L1518.55 497.757Z" fill="#cccccc"/>
        <Path id="22" d="M1599.55 497.595L1666.5 497.595L1666 594.095L1599.55 594.095L1599.55 497.595Z" fill="#cccccc"/>
        <Path id="23" d="M1682.55 498.014L1749.5 498.014L1749 594.514L1682.55 594.514L1682.55 498.014Z" fill="#cccccc"/>
        <Path id="24" d="M1765.55 481.014L1847 481.014L1847 594.5L1765.55 594.5L1765.55 481.014Z" fill="#cccccc"/>
        <Path id="25" d="M1864.55 481L1914.5 481L1914.5 596.5L1864.55 596.5L1864.55 481Z" fill="#cccccc"/>
        <Path id="26" d="M1931.83 480.979L1981.77 480.979L1981.77 596.479L1931.83 596.479L1931.83 480.979Z" fill="#cccccc"/>
        <Path id="27" d="M1931.83 319.979L1981.77 319.979L1981.77 451.5L1931.83 451.5L1931.83 319.979Z" fill="#cccccc"/>
        <Path id="28" d="M1864.74 319.979L1914.69 319.979L1914.69 451.5L1864.74 451.5L1864.74 319.979Z" fill="#cccccc"/>
        <Path id="29" d="M1937.5 142.5L1981.69 146.5L1981.69 298.5L1931.74 298.5L1931.74 201L1937.5 142.5Z" fill="#cccccc"/>
        <Path id="30" d="M1868.5 136.5L1920.5 140.5L1916.5 196.5L1914.69 298.5L1864.74 298.5L1864.74 180.5L1868.5 136.5Z" fill="#cccccc"/>
        <Path id="31" d="M1752 214.979L1845.69 214.979L1845.69 358L1752 358L1752 214.979Z" fill="#cccccc"/>
        <Path id="32" d="M1721 123.5L1851.5 135L1848 213.5L1716 213.5L1721 123.5Z" fill="#cccccc"/>
        <Path id="33" d="M1424 96.9999L1703.2 120.955L1699.5 169.5L1699.5 213L1448.5 213L1419 202.5L1424 96.9999Z" fill="#cccccc"/>
        <Path id="34" d="M1716.12 230L1748.5 230L1748.5 359L1716.12 359L1716.12 230Z" fill="#cccccc"/>
        <Path id="35" d="M1616.44 230.876L1699 230.876L1699 468L1616.44 469L1616.44 230.876Z" fill="#cccccc"/>
        <Path id="36" d="M1325.5 88.0002L1406.5 95.5002L1400.5 197L1370.5 197L1358 191L1346 183L1338 174.5L1330.5 164.5L1325 153L1322 138.5L1322.5 124L1325.5 88.0002Z" fill="#cccccc"/>
        <Path id="37" d="M1104.5 315.679L1152.79 315.679L1152.79 383.5L1104.5 383.5L1104.5 315.679Z" fill="#cccccc"/>
        <Path id="38" d="M1105.12 400.781L1153.41 400.781L1153.41 468.602L1105.12 468.602L1105.12 400.781Z" fill="#cccccc"/>
        <Path id="39" d="M1054 400.781L1087.41 400.781L1087.41 468.602L1054 468.602L1054 400.781Z" fill="#cccccc"/>
        <Path id="40" d="M1053.12 316L1086.53 316L1086.53 383.821L1053.12 383.821L1053.12 316Z" fill="#cccccc"/>
        <Path id="41" d="M1004.12 315.5L1037.53 315.5L1037.53 468.821L1004.12 468.821L1004.12 315.5Z" fill="#cccccc"/>
        <Path id="42" d="M1004.12 485L1037.53 485L1037.53 547.5L1004.12 547.5L1004.12 485Z" fill="#cccccc"/>
        <Path id="43" d="M1055 160.5L1152.5 169L1152.5 203L1054 195L1055 160.5Z" fill="#cccccc"/>
        <Path id="44" d="M363.772 478.397L407.772 449.897L433.5 487.5L472 517L477.5 559L420.5 559L406 547L363.772 478.397Z" fill="#cccccc"/>
        <Path id="45" d="M211.5 238L218.5 233L256 232L257 241L260.5 251.5L267.5 264.5L276 274.5L284.5 281L296 286.5L308 290L340.272 341.897L295.772 369.897L211.5 238Z" fill="#cccccc"/>
        <Path id="46" d="M905.116 147.548L1037 159L1037 213.5L905.116 213.5L905.116 147.548Z" fill="#cccccc"/>
        <Path id="47" d="M822.5 140L888 145L888 213.5L821.5 213.5L822.5 140Z" fill="#cccccc"/>
        <Path id="48" d="M822 315.5L888 315.5L888 469.5L822 469.5L822 315.5Z" fill="#cccccc"/>
        <Path id="49" d="M908.436 315.901L1001.5 315.901L1001.5 465.5L908.436 465.5L908.436 315.901Z" fill="#cccccc"/>
        <Path id="50" d="M822 230L888.5 230L888.5 298.5L822 298.5L822 230Z" fill="#cccccc"/>
        <Path id="51" d="M764.5 40L814.301 42.5L808 121.5L699.5 113L693.5 78.5L761.5 84.5L764.5 40Z" fill="#cccccc"/>
        <Path id="52" d="M373 257.5L409.5 276.5L397.5 298L383.5 314.5L367.5 326L356.5 333.5L328 290L340.5 287L352 282L363 271L373 257.5Z" fill="#cccccc"/>
        <Path id="53" d="M458 437.5L467.5 492.5L445.5 477.5L424.5 442.5L458 437.5Z" fill="#cccccc"/>
        <Path id="54" d="M431.5 270.5L456 416.5L412 424.5L363.5 347.5L378 338.5L391.5 328L400.5 318.5L409.5 308.5L416.5 296L423 284L426.5 270.5H431.5Z" fill="#cccccc"/>
        <Path id="55" d="M903.5 485H953.5V594.5H903.5V485Z" fill="#cccccc"/>
        <Path id="56" d="M1446.5 344.5H1500.5L1496.5 368L1487.5 392.5L1477 412L1465.5 426.5L1454 436L1421 396.5L1434 381.5L1442.5 364.5L1446.5 344.5Z" fill="#cccccc"/>
        <Path id="57" d="M1318 382L1333.5 397L1346 405L1358.5 410L1372.5 411.5L1390.5 410L1414.3 402L1440.5 446.5L1426.5 453L1409 459L1392.5 463.5H1374L1352.5 461.5L1335 456.5L1318 449V382Z" fill="#cccccc"/>
      </G>
